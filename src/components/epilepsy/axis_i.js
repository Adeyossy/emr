...
export default class AxisIComponent extends React.Component {
  ...
  onItemChange = (id, value) => {
    this.props.updateAnyObject(id, value, ["appointment", "forms", "epilepsy", "axisI"], null);
  }

  onMultiItemChange = (id, value) => {
    this.props.updateItemsInArray(
      ["appointment", "forms", "epilepsy", "axisI", id], value.split(", "), null);
  }
  ...
  componentDidUpdate() {
    // console.log("Patient => ", this.context.appointment.forms.epilepsy);
  }
      ...
      <div className="emr-clerking-tab-data m-0">
        ...
        <div className="emr-clerking-tab-data-items">
          <details className="emr-clerking-tab-data-item"
            open={this.context.appointment.forms.epilepsy.axisI.aura_side}>
            <summary htmlFor="familyhistory">Aura</summary>
            <div className="emr-clerking-tab-data-items">
              <SingleSelectOutputComponent name={""} id={"aura_side"}
                value={this.context.appointment.forms.epilepsy.axisI.aura_side}
              ...
              <MultiSelectOutputComponent name={"Visual Hallucination"} id={"visual_hallucination"}
                value={this.context.appointment.forms.epilepsy.axisI.visual_hallucination.join(", ")}
              ...
              <MultiSelectOutputComponent name={"Dysaesthesia"} id={"dysaesthesia"}
                value={this.context.appointment.forms.epilepsy.axisI.dysaesthesia.join(", ")}
              ...
              <SingleSelectOutputComponent name={"Abdominal"} id={"abdominal"}
                value={this.context.appointment.forms.epilepsy.axisI.abdominal}
                items={["Yes", "No"]} onItemChange={this.onItemChange} />
              <MultiSelectOutputComponent name={"Psychic"} id={"psychic"}
                value={this.context.appointment.forms.epilepsy.axisI.psychic.join(", ")}
              ...
              <MultiSelectOutputComponent name={"Auditory"} id={"auditory"}
                value={this.context.appointment.forms.epilepsy.axisI.auditory.join(", ")}
                items={["Simple hallucinations e.g. buzz",
                  "Vertiginous symptoms"]}
                onItemChange={this.onMultiItemChange} />
              <MultiSelectOutputComponent name={"Autonomic"} id={"autonomic"}
                value={this.context.appointment.forms.epilepsy.axisI.autonomic.join(", ")}
          ...
          <details className="emr-clerking-tab-data-item"
            open={this.context.appointment.forms.epilepsy.axisI.consciousness_alteration_duration}>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"consciousness_alteration_duration"} title={"Duration"}
                          value={this.context.appointment.forms.epilepsy.axisI.consciousness_alteration_duration}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"consciousness_alteration_description"} title={"Describe"}
                          value={this.context.appointment.forms.epilepsy.axisI.consciousness_alteration_description}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"blank_spell_duration"} title={"Duration"}
                          value={this.context.appointment.forms.epilepsy.axisI.blank_spell_duration}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"blank_spell_description"} title={"Describe"}
                          value={this.context.appointment.forms.epilepsy.axisI.blank_spell_description}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"amnesia_duration"} title={"Duration"}
                          value={this.context.appointment.forms.epilepsy.axisI.amnesia_duration}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                      <div className="col-md-6">
                        <LabelAndInputComponent id={"amnesia_description"} title={"Describe"}
                          value={this.context.appointment.forms.epilepsy.axisI.amnesia_description}
                          onItemChange={this.onItemChange} type={"text"} />
                      </div>
                    </div>
                  </div>
          ...
          <details className="emr-clerking-tab-data-item"
            open={this.context.appointment.forms.epilepsy.axisI.motor_side}>
            <summary>Motor</summary>
            <div className="emr-clerking-tab-data-items">
              <SingleSelectOutputComponent name={""} id={"motor_side"}
                value={this.context.appointment.forms.epilepsy.axisI.motor_side}
                items={["Left", "Right", "Both"]} onItemChange={this.onItemChange} />
              <LabelAndInputComponent id={"clonus_description"} title={"Clonus (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.clonus_description}
                onItemChange={this.onItemChange} type={"text"} />
              <div className="emr-clerking-tab-data-item">
                <h4 className="emr-card-headers">Tonic (describe)</h4>
                <div className="emr-clerking-tab-data-items">
                  <LabelAndInputComponent id={"tonic_description"} title={"Describe"}
                    value={this.context.appointment.forms.epilepsy.axisI.tonic_description}
                    onItemChange={this.onItemChange} type={"text"} />
                  <MultiSelectOutputComponent name={"Version or other"} id={"motor_version"}
                    value={this.context.appointment.forms.epilepsy.axisI.motor_version.join(", ")}
              ...
              <LabelAndInputComponent id={"myoclonus_description"} title={"Myoclonus (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.myoclonus_description}
                onItemChange={this.onItemChange} type={"text"} />
              <LabelAndInputComponent id={"version_description"} title={"Version (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.version_description}
                onItemChange={this.onItemChange} type={"text"} />
              <LabelAndInputComponent id={"atonic_description"} title={"Atonic (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.atonic_description}
                onItemChange={this.onItemChange} type={"text"} />
              <LabelAndInputComponent id={"hypermotor_description"} title={"Hyper-motor (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.hypermotor_description}
                onItemChange={this.onItemChange} type={"text"} />
              <LabelAndInputComponent id={"akinetic_description"} title={"Akinetic (describe)"}
                value={this.context.appointment.forms.epilepsy.axisI.akinetic_description}
                onItemChange={this.onItemChange} type={"text"} />
              <details className="emr-clerking-tab-data-item">
                ...
                <MultiSelectOutputComponent name={"Automatism (smack lips, fidget, behave in an unusual way)"}
                  ...
                  value={this.context.appointment.forms.epilepsy.axisI.automatism.join(", ")}
                  items={["Oro-alimentary", "Gestural", "Manipulative e.g. picking"]} />
                <div className="emr-clerking-tab-data-items">
                  <LabelAndInputComponent id={"automatism_duration"} title={"Duration"}
                    value={this.context.appointment.forms.epilepsy.axisI.automatism_duration}
                    onItemChange={this.onItemChange} type={"text"} />
                  <LabelAndInputComponent id={"automatism_description"} title={"Describe"}
                    value={this.context.appointment.forms.epilepsy.axisI.automatism_description}
                    onItemChange={this.onItemChange} type={"text"} />
                </div>
              </details>
            </div>
          ...
          <MultiSelectOutputComponent name={"Others"} id={"others_axis_i"}
            ...
            value={this.context.appointment.forms.epilepsy.axisI.others_axis_i.join(", ")}
            onItemChange={this.onMultiItemChange} />
          <details className="emr-clerking-tab-data-item">
            ...
            <div className="emr-clerking-tab-data-items">
              <MultiSelectOutputComponent name={"Post-ictal manifestations"}
                ...
                value={this.context.appointment.forms.epilepsy.axisI.postictal_manifestation.join(", ")}
              ...
              <LabelAndInputComponent id={"postictal_duration"} type={"text"}
                value={this.context.appointment.forms.epilepsy.axisI.postictal_duration}
          ...
          <LabelAndInputComponent id={"time_of_day"} type={"text"}
            ...
            value={this.context.appointment.forms.epilepsy.axisI.time_of_day}
            onItemChange={this.onItemChange} />
          <LabelAndInputComponent id={"more_at_night_or_day"} type={"text"}
            title={"Does your attack occur more at night or day? From sleep"}
            value={this.context.appointment.forms.epilepsy.axisI.more_at_night_or_day}
            onItemChange={this.onItemChange} />
