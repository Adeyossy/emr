      ...
      <div className="emr-clerking-tab-data m-0">
        ...
        <div className="emr-clerking-tab-data-items">
          <LabelAndInputComponent id="date_seen" title="Date of Encounter"
            value={new Date(this.props.patient[this.props.patient.last_viewed].date_seen).toISOString().substring(0, 16)}
            type="datetime-local" onItemChange={this.onItemChange} />
          <div className={`emr-clerking-tab-data-item ${this.props.patient[this.props.patient.last_viewed].biodata.firstname
            && this.props.patient[this.props.patient.last_viewed].biodata.lastname ? "filled" : ""}`}>
            <label htmlFor="firstname">Name</label>
            <div className="emr-clerking-biodata-names">
              <input type="text" name="lastname" id="lastname" placeholder="Surname"
                value={this.props.patient[this.props.patient.last_viewed].biodata.lastname} onChange={this.updateField}
                className={this.props.patient[this.props.patient.last_viewed].biodata.lastname ? "filled" : ""} required></input>
              <input type="text" name="firstname" id="firstname" placeholder="First name"
                value={this.props.patient[this.props.patient.last_viewed].biodata.firstname} onChange={this.updateField}
                className={this.props.patient[this.props.patient.last_viewed].biodata.firstname ? "filled" : ""} required></input>
              <input type="text" name="middlename" id="middlename" placeholder="Middle name"
                value={this.props.patient[this.props.patient.last_viewed].biodata.middlename} onChange={this.updateField}
                className={this.props.patient[this.props.patient.last_viewed].biodata.middlename ? "filled" : ""} required></input>
            </div>
          </div>
          <LabelAndInputComponent id="ageinyears" title="Age (in years)"
            value={this.props.patient[this.props.patient.last_viewed].biodata.ageinyears}
            type="text" onItemChange={this.onItemChange} />
          <SingleSelectOutputComponent name={"Gender"} id={"gender"} items={["Male", "Female"]}
            value={this.props.patient[this.props.patient.last_viewed].biodata.gender}
            onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="occupation" title="Occupation"
            value={this.props.patient[this.props.patient.last_viewed].biodata.occupation}
            type="text" onItemChange={this.onItemChange} />
          <SingleSelectOutputComponent name={"Marital Status"} id={"maritalstatus"}
            items={["Single", "Married", "Separated", "Divorced", "Widowed"]}
            value={this.props.patient[this.props.patient.last_viewed].biodata.maritalstatus}
            onItemChange={this.onItemChange} displayInBox={this.displaySelectedInInputBox} />
          <NotesComponent id="address" name="Address" value={this.props.patient[this.props.patient.last_viewed].biodata.address}
            onItemChange={this.props.updateAnyObject} fields={["biodata"]} />
          <LabelAndInputComponent id="state" title="State"
            value={this.props.patient[this.props.patient.last_viewed].biodata.state}
            type="text" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="city" title="City"
            value={this.props.patient[this.props.patient.last_viewed].biodata.city}
            type="text" onItemChange={this.onItemChange} />
          <SingleSelectOutputComponent name={"Religion"} id={"religion"}
            items={["Christianity", "Islam", "Traditional"]}
            value={this.props.patient[this.props.patient.last_viewed].biodata.religion}
            onItemChange={this.onItemChange} displayInBox={this.displaySelectedInInputBox} />
          <SingleSelectOutputComponent name={"Tribe"} id={"tribe"}
            items={["Yoruba", "Igbo", "Hausa", "Fulani", "Ibiobio", "Kanuri"]}
            value={this.props.patient[this.props.patient.last_viewed].biodata.tribe}
            onItemChange={this.onItemChange} displayInBox={this.displaySelectedInInputBox} />
          <LabelAndInputComponent id="hospital" title="Hospital"
            value={this.props.patient[this.props.patient.last_viewed].biodata.hospital}
            type="text" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="id" title="Identification Number"
            value={this.props.patient[this.props.patient.last_viewed].biodata.id}
            type="text" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="phone_number" title="Phone Number"
            value={this.props.patient[this.props.patient.last_viewed].biodata.phone_number}
            type="tel" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="phone_number_1" title="Alternate Phone Number"
            value={this.props.patient[this.props.patient.last_viewed].biodata.phone_number_1}
            type="tel" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="email_address" title="Email Address"
            value={this.props.patient[this.props.patient.last_viewed].biodata.email_address}
            type="email" onItemChange={this.onItemChange} />
          <LabelAndInputComponent id="next_of_kin" title="Next of Kin Name"
            value={this.props.patient[this.props.patient.last_viewed].biodata.next_of_kin} type="text"
            onItemChange={this.onItemChange} />
          <SingleSelectOutputComponent name="Relationship to next of kin"
            id="next_of_kin_relationship" value={this.props.patient[this.props.patient.last_viewed].biodata.next_of_kin_relationship}
